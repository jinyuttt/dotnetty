...
namespace DotNetty.Transport.Bootstrapping
{
        ...
        where TChannel : IChannel
    {
        ...
        protected static void SetChannelOptions(IChannel channel, ICollection<ChannelOptionValue> options, Logger logger)
        {
        ...
        protected static void SetChannelOptions(IChannel channel, ChannelOptionValue[] options, Logger logger)
        {
            foreach (var e in options)
            {
                SetChannelOption(channel, e, logger);
        ...
        protected static void SetChannelOption(IChannel channel, ChannelOptionValue option, Logger logger)
        {
            try
            {
