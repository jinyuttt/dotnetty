...
namespace DotNetty.Transport.Channels
{
    ...
    static class Util
    {
        static readonly Logger Log = Logger.Singleton;
        ...
        /// <param name="logger">The <see cref="Logger"/> to use to log a failure message.</param>
        public static void SafeSetSuccess(TaskCompletionSource promise, Logger logger)
        {
        ...
        /// <param name="logger">The <see cref="Logger"/> to use to log a failure message.</param>
        public static void SafeSetFailure(TaskCompletionSource promise, Exception cause, Logger logger)
        {
